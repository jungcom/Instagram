...
- [0] User can sign up to create a new account using Parse authentication (+1pt)
- [0] User can log in and log out of his or her account (+1pt)
- [0] The current signed in user is persisted across app restarts (+1pt)
- [0] User can take a photo, add a caption, and post it to "Instagram" (+2pt)
- [0] User can view the last 20 posts submitted to "Instagram" (+2pt)
- [0] User can pull to refresh the last 20 posts submitted to "Instagram" (+1pt)
- [0] User can tap a post to view post details, including timestamp and caption (+2pt)
...
<img src='https://i.imgur.com/b8FSZ7T.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
